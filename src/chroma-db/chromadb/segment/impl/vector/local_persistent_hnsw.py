...
from chromadb.segment.impl.vector.local_hnsw import DEFAULT_CAPACITY
...
from chromadb.utils.read_write_lock import ReadRWLock
...
class PersistentLocalHnswSegment(LocalHnswSegment):
    ...
    _batch_size: int
    _brute_force_index: BruteForceIndex | None
    _curr_batch: Batch
