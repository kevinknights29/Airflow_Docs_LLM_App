...
def test_upsert(api):
    ...
    get_result = collection.get(
        ...
        ids=new_records["ids"][0],
    )
    assert vector_approx_equal(
        get_result["embeddings"][0],
        new_records["embeddings"][0],
    )
