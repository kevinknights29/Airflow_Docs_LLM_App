...
from chromadb.api.types import validate_ids
from chromadb.api.types import validate_include
from chromadb.api.types import validate_metadata
from chromadb.api.types import validate_metadatas
from chromadb.api.types import validate_n_results
...
class Collection(BaseModel):
    ...
    _embedding_function: EmbeddingFunction | None = PrivateAttr()
