...
from chromadb.errors import InvalidUUIDError
from chromadb.server.fastapi.types import AddEmbedding
from chromadb.server.fastapi.types import CreateCollection
from chromadb.server.fastapi.types import DeleteEmbedding
from chromadb.server.fastapi.types import GetEmbedding
from chromadb.server.fastapi.types import QueryEmbedding
from chromadb.server.fastapi.types import RawSql
from chromadb.server.fastapi.types import UpdateCollection
from chromadb.server.fastapi.types import UpdateEmbedding
from chromadb.telemetry import ServerContext
...
async def catch_exceptions_middleware(
    ...
    try:
        ...
        return JSONResponse(
            content={"error": e.name(), "message": e.message()},
            status_code=e.code(),
        )
