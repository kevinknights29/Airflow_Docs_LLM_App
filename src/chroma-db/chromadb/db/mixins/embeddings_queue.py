...
from chromadb.db.base import ParameterValue
from chromadb.db.base import SqlDB
from chromadb.ingest import Consumer
from chromadb.ingest import ConsumerCallbackFn
from chromadb.ingest import decode_vector
from chromadb.ingest import encode_vector
...
class SqlEmbeddingsQueue(SqlDB, Producer, Consumer):
    ...
    def submit_embedding(
        self,
        topic_name: str,
        embedding: SubmitEmbeddingRecord,
    ) -> SeqId:
